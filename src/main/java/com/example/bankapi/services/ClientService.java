...
public interface ClientService {
     ...
     */
    List<CardRespDTO> getClientCards(long accountId) throws EmptyAccountException;
     ...
     */
    AccRespDTO getClientAccountBalance(long accountId) throws ThereIsNoSuchAccountException;
     ...
     * @throws ThereIsNoSuchAccountException  account with such id not found
     */
    void depositClientMoney(long accountId, AccReqDTO accReqDTO) throws ThereIsNoSuchAccountException;
     ...
     */
    void addNewCardByAccountId(long accountId, CardReqDTO cardReqDTO) throws ThereIsNoSuchAccountException,NotEqualAccountIdException;
}
